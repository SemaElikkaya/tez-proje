...
export default function More() {
    return (
        ...
        <Popover className="relative">
            ...
            <Popover.Panel className="w-[318px] absolute bottom-0 left-0 bg-black shadow-box ovverflow-hidden rounded-lg">
                    ...
                    {({ open }) => (
                        <>
                            <Disclosure.Button className="h-[52px] flex items-center justify-between w-full px-4 font-bold hover:bg-[#eff3f41a]">
                                ...
                                <svg className={classNames("transition-all", { " rotate-180 text-[#1d9bf0]": open })} viewBox="0 0 24 24" width={18.75} height={18.75}>
                                    <path
                                        fill="currentColor"
