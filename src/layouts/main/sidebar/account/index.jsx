        ...
        <div className="mt-auto">
            <Popover className="relative">
                <Popover.Button className="my-3 p-3 rounded-full hover:bg-[#eff3f41a] w-full flex text-left items-center transition-colors outline-none">
                    <img src={account.avatar} className="w-10 h-10 rounded-full flex" alt="" />
                ...
                >
                    <Popover.Panel
                        className="absolute bottom-[80px] py-3 w-[300px] overflow-hidden left-1/2 -translate-x-1/2 bg-black shadow-box rounded-2xl">
                        {({close}) => (
                            <More close={close}/>
                        )}
                    </Popover.Panel>
